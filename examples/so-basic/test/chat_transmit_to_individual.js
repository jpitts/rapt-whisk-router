/*
  ...
  Overview:
    ...
    Test involves JQGO client0 and node-based client1. Both clients visit http://localhost:9090.
  ...
  Basic tasks of this test:
    ...
    JQGO: visit/wait/get page http://localhost:9090
          ...
          async.until(
            ...
            function () {
              ...
              jqgo('#status').html(function(message) {
                ...
                var regex = /Connection to So Basic active/g;
