...
API.init = function (cfg_data) {
  ...
  */ 
  ...
  cfg = {
    session: {
      secret: (typeof cfg_data.session.secret !== 'undefined') ? cfg_data.session.secret : default_cfg.session.secret,
      key: (typeof cfg_data.session.key !== 'undefined') ? cfg_data.session.key : default_cfg.session.key,
      prefix: (typeof cfg_data.session.prefix !== 'undefined') ? cfg_data.session.prefix : default_cfg.session.prefix
    }
  };
