...
WSLoader.prototype.init = function(attr, cb) {
  ...
  */
  ...
  // load routes  
	Router.load_route_configs(attr);
	
  // load observers
  Router.load_observer_configs(attr);
...
function on_connection(socket) {
  ...
  */
  ...
  Router.attach_routes_to_socket(socket);
  ...
  // default behavior: perform the session sync on connection
  } else {
